...
const CollapsibleStack = (
  ...
  React.useEffect(() => {
    const handleOrientationChange = ({ window }: { window: ScaledSize }) => {
      ...
      if (navigationSetParam) navigationSetParam({ isDirty: true });
    };
  ...
  return (
    <Stack.Screen
      ...
      options={({
        ...
        if (route.params?.isDirty || route.params?.collapsible == null) {
          navigation.setParams({ collapsible, isDirty: false });
        }
